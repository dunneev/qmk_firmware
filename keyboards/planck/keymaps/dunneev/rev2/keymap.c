...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * `-----------------------------------------------------------------------------------'
     */
    [_RAISE] = LAYOUT_planck_grid(KC_GESC,KC_EXLM,KC_PIPE,KC_AMPR,KC_PEQL,KC_HASH,KC_AMPR,KC_PMNS,KC_PPLS,KC_PAST,KC_DEL,KC_BSPC,KC_TAB,KC_LCBR,KC_LPRN,KC_RPRN,KC_RCBR,KC_DLR,KC_LEFT,KC_DOWN,KC_UP,KC_RGHT,KC_SCLN,RCS(KC_Z),KC_LSFT,KC_LBRC,KC_LT,KC_GT,KC_RBRC,KC_PDOT,KC_HOME,KC_PGDN,KC_PGUP,KC_END,KC_QUES,KC_RSFT,KC_LCTL,LCTL(KC_Z),LCTL(KC_X),LCTL(KC_C),KC_TRNS,KC_SPC,KC_SPC,KC_TRNS,KC_UNDS,KC_BSLS,LCTL(KC_V),KC_SFTENT),
     ...
     * `-----------------------------------------------------------------------------------'
     */
    [_ADJUST] = LAYOUT_planck_grid(KC_PWR,KC_SLEP,KC_WAKE,KC_NO,CK_UP,KC_NO,KC_NO,KC_BTN1,KC_BTN2,KC_BTN3,KC_BTN4,KC_VOLU,DF(0),DF(1),DF(2),KC_NO,CK_DOWN,KC_NO,KC_NO,KC_MS_L,KC_MS_D,KC_MS_U,KC_MS_R,KC_VOLD,KC_NO,KC_NO,AU_TOG,MU_TOG,CK_TOGG,MI_ON,MI_OFF,KC_ACL0,KC_ACL1,KC_ACL2,KC_MSTP,KC_MUTE,BL_STEP,BL_BRTG,AU_OFF,MU_MOD,KC_TRNS,KC_BRID,KC_BRIU,KC_TRNS,KC_NO,KC_MPRV,KC_MPLY,KC_MNXT)
