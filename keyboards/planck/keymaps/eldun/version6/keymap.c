...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * `-----------------------------------------------------------------------------------'
     */
    [_LOWER] = LAYOUT_planck_grid(KC_TRNS,KC_F1,KC_F2,KC_F3,KC_F4,KC_LPRN,KC_RPRN,KC_7,KC_8,KC_9,KC_PPLS,KC_BSPC,KC_TAB,KC_F5,KC_F6,KC_F7,KC_F8,KC_LPRN,KC_RPRN,KC_4,KC_5,KC_6,KC_PMNS,KC_PERC,KC_LSFT,KC_F9,KC_F10,KC_F11,KC_F12,KC_LPRN,KC_RPRN,KC_1,KC_2,KC_3,KC_PAST,KC_CIRC,KC_LCTL,LCTL(KC_Z),KC_CAPS,KC_TRNS,KC_TRNS,KC_SPC,KC_SPC,KC_TRNS,KC_0,KC_PDOT,KC_PSLS,TD(EQUALS_SIGN_ENTER_DANCE)),
     ...
     * `-----------------------------------------------------------------------------------'
     */
    [_ADJUST] = LAYOUT_planck_grid(KC_PWR,KC_SLEP,KC_WAKE,KC_MYCM,CK_UP,KC_NO,KC_BTN1,KC_BTN2,KC_BTN3,KC_BTN4,KC_NO,KC_VOLU,QWERTY,COLEMAK,DVORAK,KC_NO,CK_DOWN,MI_OFF,KC_MS_L,KC_MS_D,KC_MS_U,KC_MS_R,KC_CALC,KC_VOLD,KC_NO,KC_NO,AU_TOG,MU_TOG,CK_TOGG,MI_ON,KC_ACL0,KC_ACL1,KC_ACL2,KC_NO,KC_MPLY,KC_MUTE,BL_STEP,BL_BRTG,AU_OFF,MU_MOD,KC_TRNS,KC_BRID,KC_BRIU,KC_TRNS,KC_NO,KC_MPRV,KC_MSTP,KC_MNXT)
